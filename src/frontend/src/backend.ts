...
import type { ExternalBlob as _ExternalBlob, Task as _Task, TaskId as _TaskId, TaskStatus as _TaskStatus, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createTask(arg0: string, arg1: string, arg2: bigint): Promise<TaskId> {
        if (this.processError) {
            try {
    ...
    async getCompletedTaskIds(): Promise<Array<TaskId>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCompletedTaskIds();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLockedTaskIds(): Promise<Array<TaskId>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLockedTaskIds();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTasksByTimeRange(arg0: bigint, arg1: bigint): Promise<Array<Task>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTasksByTimeRange(arg0, arg1);
                return from_candid_vec_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async startFocusSession(arg0: TaskId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitProof(arg0: TaskId, arg1: string | null, arg2: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitProof(arg0, to_candid_opt_n22(this._uploadFile, this._downloadFile, arg1), await to_candid_opt_n23(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Task_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Task): Promise<Task> {
...
async function from_candid_opt_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Task]): Promise<Task | null> {
    return value.length === 0 ? null : await from_candid_Task_n13(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        title: value.title,
        proofText: record_opt_to_undefined(from_candid_opt_n18(_uploadFile, _downloadFile, value.proofText)),
        owner: value.owner,
        createdAt: value.createdAt,
        description: value.description,
        durationMinutes: value.durationMinutes,
        proofImage: record_opt_to_undefined(await from_candid_opt_n19(_uploadFile, _downloadFile, value.proofImage))
    };
}
...
function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? TaskStatus.pending : "completed" in value ? TaskStatus.completed : "locked" in value ? TaskStatus.locked : value;
}
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Task>): Promise<Array<Task>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Task_n13(_uploadFile, _downloadFile, x)));
}
